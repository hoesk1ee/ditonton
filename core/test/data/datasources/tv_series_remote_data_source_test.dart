...
void main() {
  ...
  group('get Now Playing Tv Series', () {
    final tTvSeriesList = TvSeriesResponse.fromJson(
      json.decode(readJson('dummy_data/tv_series_dummy/on_the_air.json')),
    ).tvSeriesList;
      ...
      () async {
        ...
        when(
          ...
          (_) async => http.Response(
            readJson('dummy_data/tv_series_dummy/on_the_air.json'),
            200,
          ),
        );
        // act
  ...
  group('get Popular Tv Series', () {
    final tTvSeriesList = TvSeriesResponse.fromJson(
      json.decode(
        readJson('dummy_data/tv_series_dummy/popular_tv_series.json'),
      ),
    ).tvSeriesList;
  ...
  group('get Top Rated Tv Series', () {
    final tTvSeriesList = TvSeriesResponse.fromJson(
      json.decode(
        readJson('dummy_data/tv_series_dummy/top_rated_tv_series.json'),
      ),
    ).tvSeriesList;
  ...
  group('get tv series detail', () {
    ...
    final tTvSeriesDetail = TvSeriesDetailResponse.fromJson(
      json.decode(readJson('dummy_data/tv_series_dummy/tv_series_detail.json')),
    );
    ...
    test(
      ...
      () async {
        ...
        when(
          ...
          (_) async => http.Response(
            readJson('dummy_data/tv_series_dummy/tv_series_detail.json'),
            200,
          ),
        );
        // act
  ...
  group('get tv series recommendations', () {
    final tTvSeriesList = TvSeriesResponse.fromJson(
      json.decode(
        readJson('dummy_data/tv_series_dummy/tv_series_recommendations.json'),
      ),
    ).tvSeriesList;
    final tId = 1;
    ...
    test(
      ...
      () async {
        ...
        when(
          ...
          (_) async => http.Response(
            readJson(
              'dummy_data/tv_series_dummy/tv_series_recommendations.json',
            ),
            200,
          ),
        );
  ...
  group('search tv series', () {
    final tSearchResult = TvSeriesResponse.fromJson(
      json.decode(
        readJson(
          'dummy_data/tv_series_dummy/search_breaking_bad_tv_series.json',
        ),
      ),
    ).tvSeriesList;
