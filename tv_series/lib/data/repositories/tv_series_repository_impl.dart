...
// ! TASK 5 : implement repo from data source
class TvSeriesRepositoryImpl implements TvSeriesRepository {
  ...
  Future<Either<Failure, String>> removeWatchlist(
    TvSeriesDetail tvSerial,
  ) async {
    try {
      final result = await localDataSource.removeWatchlist(
        TvSeriesTable.fromEntity(tvSerial),
      );
      return Right(result);
  ...
  @override
  Future<Either<Failure, String>> saveWatchlist(TvSeriesDetail tvSerial) async {
    try {
