...
import 'package:tv_series/presentation/providers/tv_series_detail_notifier.dart';
...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      when(mockNotifier.tvSerialState).thenReturn(RequestState.Loading);
  ...
  testWidgets('should display error message when tvSeriesState is Error', (
    ...
    when(mockNotifier.tvSerialState).thenReturn(RequestState.Error);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      when(mockNotifier.tvSerialState).thenReturn(RequestState.Loaded);
      when(mockNotifier.tvSerial).thenReturn(testTvSeriesDetail);
